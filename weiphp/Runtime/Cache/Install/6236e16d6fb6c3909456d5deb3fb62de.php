...
<html>
    <head>
        ...
        <![endif]-->
        <script src="/weiphp/Public/static/jquery-1.10.2.min.js?v=<?php echo SITE_VERSION;?>"></script>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/weiphp/install.php?s=/install/step2.html" method="post" target="_self">
        <div class="create-database">
            ...
            <div>
                <input type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_DB")): echo (SAE_MYSQL_DB); else: ?>weip<?php endif; ?>">
                <span>数据库名</span>
            </div>
            <div>
                <input type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_USER")): echo (SAE_MYSQL_USER); else: ?>root<?php endif; ?>">
                <span>数据库用户名</span>
            </div>
            <div>
                <input type="password" name="db[]" value="<?php if(defined("SAE_MYSQL_PASS")): echo (SAE_MYSQL_PASS); else: ?>root<?php endif; ?>">
                <span>数据库密码</span>
            </div>
        ...
        <div class="create-database">
            ...
            <div>
                <input type="password" name="admin[]" value="123456">
                <span>密码</span>
            </div>
            <div>
                <input type="password" name="admin[]" value="123456">
            ...
            <div>
                <input type="text" name="admin[]" value="123456@qq.com">
